...
function rowToLMIA(row: EmployerLMIARow): EmployerLMIA {
  return {
    ...
    negativeDecisions: row.negative_decisions,
    approvalRate: row.approval_rate,
    foreignWorkersEstimated: row.foreign_workers_estimated,
    approvedPositions: row.approved_positions,
    wageAverage: row.wage_average,
    wageMedian: row.wage_median,
