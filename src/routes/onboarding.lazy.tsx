...
function OnboardingWizard() {
  ...
  const inputClass = "mt-2 w-full rounded-2xl border border-[#E5E7EB] bg-white px-5 py-3.5 text-[16px] text-[#1A1A2E] placeholder:text-[#6B7280] focus:border-[#2563EB] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10";
  const selectClass = "mt-2 w-full rounded-2xl border border-[#E5E7EB] bg-white px-5 py-3.5 text-[16px] text-[#1A1A2E] focus:border-[#2563EB] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/10";

  return (
    <div className="mx-auto max-w-xl px-6 py-16">
      <div className="mb-12 text-center">
        <span className="text-sm font-semibold uppercase text-[#6B7280]">Profile Setup</span>
        <h1 className="mt-3 text-[32px] font-bold tracking-[-0.03em] text-[#1A1A2E]">Complete Your Profile</h1>
          ...
          {Array.from({ length: TOTAL_STEPS }).map((_, i) => {
            ...
            return (
              <div key={i} className="flex items-center">
                <div className={`flex h-12 w-12 items-center justify-center rounded-full text-sm font-semibold ${isDone ? "bg-[#2563EB] text-white" : isActive ? "bg-[#2563EB] text-white ring-4 ring-[#DBEAFE]" : "bg-[#F3F4F6] text-[#6B7280]"}`}>
                ...
                {i < TOTAL_STEPS - 1 && <div className={`mx-1 h-0.5 w-8 rounded transition-colors sm:w-14 ${stepNum <= step ? "bg-[#2563EB]" : "bg-[#F3F4F6]"}`} />}
              </div>
            );
          })}
        </div>
      ...
      <div className="rounded-2xl border border-[#E5E7EB] bg-white p-8  sm:p-10">
        {/* Step content */}
        {step === 1 && (
          <div className="space-y-6">
            <div>
              <label htmlFor="fullName" className="block text-sm font-semibold text-[#1A1A2E]">Full Name *</label>
            ...
            <div>
              <label htmlFor="linkedin" className="block text-sm font-semibold text-[#1A1A2E]">LinkedIn URL</label>
            ...
            <div>
              <label htmlFor="workAuth" className="block text-sm font-semibold text-[#1A1A2E]">Work Authorization Status *</label>
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div>
              <label htmlFor="education" className="block text-sm font-semibold text-[#1A1A2E]">Education Level *</label>
            ...
            <div>
              <label htmlFor="experience" className="block text-sm font-semibold text-[#1A1A2E]">Years of Experience *</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-[#1A1A2E]">Skills</label>
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div>
              <label htmlFor="province" className="block text-sm font-semibold text-[#1A1A2E]">Preferred Province *</label>
            ...
            <div>
              <label htmlFor="salary" className="block text-sm font-semibold text-[#1A1A2E]">Preferred Salary Range *</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-[#1A1A2E]">Upload Resume</label>
              ...
              <input ref={fileInputRef} type="file" accept=".pdf,.doc,.docx,.txt" onChange={handleFileChange}
                className="mt-3 block w-full text-sm text-[#6B7280] file:mr-5 file:rounded-2xl file:border-0 file:bg-[#F3F4F6] file:px-5 file:py-2.5 file:text-sm file:font-semibold file:text-[#1A1A2E] hover:file:bg-[#F3F4F6]" />
            ...
            <div className="space-y-3 rounded-2xl border border-[#E5E7EB] bg-white p-6">
              {[
                ...
                <div key={label} className="flex items-start justify-between gap-4 border-b border-[#E5E7EB] pb-3 last:border-0 last:pb-0">
                  ...
                  <span className="text-right text-sm font-semibold text-[#1A1A2E]">{value}</span>
                </div>
              ))}
            </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          {step > 1 ? (
            <button type="button" onClick={() => setStep((s) => s - 1)} className="inline-flex items-center gap-2 rounded-2xl border border-[#E5E7EB] bg-white px-6 py-3 text-[16px] font-medium text-[#1A1A2E] transition-colors hover:bg-white">
